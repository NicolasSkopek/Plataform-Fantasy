...
class Game:
    ...
    def __init__(self):
        ...
        self.enemy0 = Obj("assets/enemy0.png", 400, 405, 36*2, 38*2, self.all_sprites, self.all_enemies)
        self.enemy1 = Obj("assets/enemy0.png", 880, 405, 36 * 2, 38 * 2, self.all_sprites, self.all_enemies)
        self.enemy2 = Obj("assets/enemy0.png", 1100, 405, 36 * 2, 38 * 2, self.all_sprites, self.all_enemies)
